...
function Footer() {
  ...
  return (
    <footer className="bg-[#1a3841] py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-start gap-4 md:gap-8 container px-4 sm:px-6">
        {/* Company Section */}
      ...
      {/* Footer Bottom */}
      <div className="pt-8 mt-8 md:mt-12 border-t border-white/20">
