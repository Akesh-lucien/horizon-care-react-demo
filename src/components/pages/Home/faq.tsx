...
function FAQSection() {
  return (
    <section className="py-16 space-y-9">
      <Heading
        ...
        center
      />
      <div className="container grid grid-cols-2 items-center gap-7">
        <Accordion type="single" collapsible className="w-full">
          {faqData.map((item, index) => (
            <AccordionItem key={item.id} value={item.id}>
              <div className="rounded-full bg-white px-8 border mb-2">
                <AccordionTrigger className="text-left font-body text-lg hover:no-underline">
